...
(function (root, factory) {
  ...
  function initialize(b) {
    ...
    for (let i = 0; i < MAX_ZOMBIES; i++) b.entities.push({
      ...
      weaponType: "standard", zombieType: "walker", alive: false, hp: 0, maxHp: healthFor("walker", b.pve.teamSize),
  ...
  function spawn(b, z) {
    ...
    const zombieType = typeFor(b.pve.wave, b.pve.queue);
  ...
  return Object.freeze({ MAX_ZOMBIES, rewards, healthFor, typeFor, initialize, choose, step, validate });
});
