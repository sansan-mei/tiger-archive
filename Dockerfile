...
COPY app-manifest.js battle-core.js battle-session.js network-session.js tank-model.js battle.js battle.css index.html battle.html manifest.webmanifest service-worker.js offline.html ./
...
COPY --chown=node:node app-manifest.js server.js room-server.js redis-store.js battle-core.js battle-session.js network-session.js tank-model.js battle.js battle.css index.html battle.html manifest.webmanifest service-worker.js offline.html ./
