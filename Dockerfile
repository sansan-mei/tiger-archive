...
COPY --chown=node:node server.js room-server.js redis-store.js battle-core.js battle-session.js network-session.js tank-model.js battle.js battle.css index.html battle.html ./
